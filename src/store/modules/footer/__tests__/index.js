...
import collections from '__mock__/services/footer/collections';
...
describe('module/Footer', () => {
  ...
  it('it will mutate the error state when it fails fetch data', async () => {
    ...
    mockGetListFooter.mockClear();
    mockGetListFooter.mockRejectedValueOnce(errorResponse);
  ...
  it('will mutate the state error when failed post data', async () => {
    ...
    mockCreateFooter.mockRejectedValueOnce(errorResponse);
  ...
  it('will mutate the state error when failed update data', async () => {
    ...
    mockUpdateFooter.mockReset();
    mockUpdateFooter.mockRejectedValueOnce(errorResponse);
  ...
  it('will mutate the state error when failed delete data', async () => {
    ...
    mockDeleteFooter.mockReset();
    mockDeleteFooter.mockRejectedValueOnce(errorResponse);
