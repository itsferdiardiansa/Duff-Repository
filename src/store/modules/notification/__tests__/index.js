...
import collections from '__mock__/services/notification/collections';
...
describe('module/Notification', () => {
  ...
  it('it will mutate the error state when it fails fetch data', async () => {
    ...
    mockGetListNotification.mockClear();
    mockGetListNotification.mockRejectedValueOnce(errorResponse);
  ...
  it('will mutate the state error when failed post data', async () => {
    ...
    mockCreateNotification.mockRejectedValueOnce(errorResponse);
  ...
  it('will mutate the state error when failed update data', async () => {
    ...
    mockUpdateNotification.mockRejectedValueOnce(errorResponse);
  ...
  it('will mutate the state error when failed delete data', async () => {
    ...
    mockDeleteNotification.mockRejectedValueOnce(errorResponse);
